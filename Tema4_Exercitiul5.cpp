...
public:
	...
	void Concatenation(CircularList List1, CircularList List2)
	{
		do
		{
			Push(List1.Next());
		} while (List1.pclist_front != List1.pclist_rear->pclist_next);

		do
		{
			Push(List2.Next());
		} while (List2.pclist_front != List2.pclist_rear->pclist_next);
	}
...
int main()
{
	...
	std::cout << "Lista 3";
	List3.Concatenation(List1, List2);
	List3.Print();
